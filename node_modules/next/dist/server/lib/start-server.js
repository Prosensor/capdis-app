...
/* build-hook-start *//*00001*/try { require('/Users/corentinadele/.cursor/extensions/wallabyjs.console-ninja-1.0.508-universal/out/buildHook/index.js').default({tool: 'next.js', checkSum: '20cd7157665e8adb45af80UlIZARsGBgwGBglZV1YDAlJUXQRU', mode: 'build.native', condition: process.env.TURBOPACK === "1" || process.env.TURBOPACK === "auto"}); } catch(cjsError) { try { import('file:///Users/corentinadele/.cursor/extensions/wallabyjs.console-ninja-1.0.508-universal/out/buildHook/index.js').then(m => m.default.default({tool: 'next.js', checkSum: '20cd7157665e8adb45af80UlIZARsGBgwGBglZV1YDAlJUXQRU', mode: 'build.native', condition: process.env.TURBOPACK === "1" || process.env.TURBOPACK === "auto"})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
